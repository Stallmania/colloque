...
<body>
    ...
    <section class="main-two">
        ...
        <h2>ACCUEIL</h2>
        <p>Georges DECOCQ</p>
        <p>Président d'Affect</p>
        <h2>INTRODUCTION</h2>
        <p>Éric FIAT</p>
        <p>Professeur à l'Université de PARIS-EST Marne la Vallée</p> 
        <h2>I. PRÉSENTATION DES TRAVAUX SUR LES QUESTIONNEMENTS ETHIQUES DU MJPM</h2>
        <h3 class="test">Présentation des travaux sur la charte d’orientation, état des lieux, déontologie</h3>
        <ul class="closedList">
            <li>Anne CARON-DÉGLISE : Magistrat au Ministère de la Justice à Paris</li>
        </ul>

        <h2>II. L'ETHIQUE DU MJPM A L'EGARD DE LA PERSONNE PROTÉGÉE</h2>
        <h3>Éthique du MJPM et vie de couple de la personne protégée</h3>
        <ul>
            <li>Nathalie PETERKA : Professeur et Directrice du DIU à la faculté de droit de l’Université PARIS-EST</li>
        </ul>

        <h3>Éthique du MJPM, gestion et transmission patrimoniale des biens</h3>
        <ul>
        ...
        <h3>Éthique du MJPM, cadre de vie et relations personnelles de la personne protégée</h3>
        <ul>
        ...
        <h2>III. L'ETHIQUE DU MJPM A L'EGARD DE LA FAMILLE DE LA PERSONNE PROTEGÉE</h2>
        ...
        <h2>IV. L'ETHIQUE DU MJPM A L'EGARD DES AUTRES INTERVENANTS PROFESSIONNELS</h2>
        ...
        <p>Raymond LE GUIDEC</p>
        <p>Professeur émérite à l'Université de NANTES</p>
    </section>
